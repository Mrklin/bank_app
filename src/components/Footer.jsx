  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      ...
      flex-wrap md:mt-0 mt-10'>
        {footerLinks.map((footerlink)=>(
          ...
          my-4 min-w-[140px]'>
            ...
            leading-[27px] text-white mb-3`}>
                {footerlink.title}
            </h4>
            <ul>
              {footerlink.links.map((link, index)=>(
                <li key={link.key} className={`font-poppins font-normal
      ...
      <div className='w-full flex justify-between items-center md:flex-row
           flex-col pt-6 mt-4 border-t-[1px] border-t-[#3f3e45]'>
        <p className={`font-poppins font-normal text-center text-[18px]
            leading-[27px] text-white mb-3`}>2021 Hoobank All Rights Reserved</p>
